...
const Tetescofy = ({ name }) => {
   return( <div className="flex flex-row items-center justify-between lg:justify-evenly hover:brightness-75 transition-all duration-300 ease-in-out cursor-pointer lg:px-8 lg:w-3/12 lg:flex-row-reverse lg:gap-1 p-2 border border-gray-300 rounded-lg bg-gray-300 w-full lg:break-words mt-auto">
    ...
    <div className="relative bg-gray-100 min-h-screen p-2">
      ...
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="w-full flex justify-between items-center">
          <h1 className=" hidden lg:flex font-semibold lg:text-2xl text-[#002444] ">
            Betting
          </h1>
      ...
      <div className="mt-5">
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-3 p-4 lg:flex-row lg:items-center lg:gap-[5%] lg:justify-between lg:space-y-6 lg:flex-wrap">
            {tetescofy.map((teteBayeje, alayeBaje)=>(
              <Tetescofy name={teteBayeje} key={alayeBaje} />
            ))}
          </div>
      </div>
    </div>
