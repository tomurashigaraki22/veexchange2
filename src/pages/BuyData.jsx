...
const BuyData = () => {
    ...
    return(
        <div className="relative bg-gray-100 min-h-screen p-2">
            ...
            <div className="mt-5">
                <p className="text-sm" style={{ fontFamily: 'Ubuntu'}}>Which Network Provider?</p>
                <div className="flex flex-col items-center space-y-3 p-4">
                    <div className="flex flex-row items-center justify-between p-2 border border-gray-300 rounded-lg bg-gray-300 w-full">
                        <p style={{ fontFamily: 'Josefin Sans'}}>9Mobile</p>
                        <div className="border border-white bg-white p-2 rounded-full">
                            <BiMobile color="black" size={15} />
                        </div>
                    </div>
                    <div className="flex flex-row items-center justify-between p-2 border border-gray-300 rounded-lg bg-gray-300 w-full">
                        <p style={{ fontFamily: 'Josefin Sans'}}>Airtel</p>
                        <div className="border border-white bg-white p-2 rounded-full">
                            <BiMobile color="black" size={15} />
                        </div>                    </div>
                    <div className="flex flex-row items-center justify-between p-2 border border-gray-300 rounded-lg bg-gray-300 w-full">
                        <p style={{ fontFamily: 'Josefin Sans'}}>GLO</p>
                        <div className="border border-white bg-white p-2 rounded-full">
                            <BiMobile color="black" size={15} />
                        </div>                    </div>
                    <div className="flex flex-row items-center justify-between p-2 border border-gray-300 rounded-lg bg-gray-300 w-full">
                        <p style={{ fontFamily: 'Josefin Sans'}}>MTN</p>
                        <div className="border border-white bg-white p-2 rounded-full">
                            <BiMobile color="black" size={15} />
                        </div>                    </div>
                </div>
