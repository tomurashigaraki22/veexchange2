    ...
    <div className="relative flex flex-col min-h-screen p-3">
      ...
      >
        <div className="flex flex-row items-center justify-between mb-4">
          <div className="flex flex-row items-center space-x-5 bg-white border-white border rounded-full px-3 py-2 lg:hidden">
        ...
        <div className="mt-8 bg-gray-100 p-4 rounded-lg shadow-md">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-row items-center space-x-3">
              <label htmlFor="cfa" className="text-gray-700 font-semibold">
                CFA:
              </label>
              <input
                id="cfa"
            ...
            <div className="flex flex-row items-center space-x-3">
              <label htmlFor="naira" className="text-gray-700 font-semibold">
                Naira:
              </label>
              <input
                id="naira"
        ...
        <div className="mt-10">
          ...
          <div className="max-h-64 shadow-md overflow-y-auto">
            {walletHistory.map((hist, index) => (
              <div
                key={index}
                className="flex flex-row items-center justify-between p-2 mb-2 border-b border-gray-200"
              >
                ...
                <div className="flex flex-col items-end ml-auto">
                  <p className="font-semibold text-green-500">
                    &#8358; {hist.amount.toLocaleString()}.00
                  </p>
                  <p
                    className={`text-sm ${
                      hist.status === 200 ? "text-green-600" : "text-yellow-600"
                    }`}
                    style={{ fontSize: 11 }}
                  >
          ...
          <p className="text-blue-300 border-b text-md text-center pt-4 mb-12">
            View Full History
          </p>
        </div>
      </div>
